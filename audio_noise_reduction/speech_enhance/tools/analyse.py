...
data1 = read_from_txt(
    "/workspace/project-nas-11025-sh/speech_enhance/egs/DNS-master/s1_16k/mertrics/fullsubnet_plus/NB_PESQ.txt"
)
data2 = read_from_txt(
    "/workspace/project-nas-11025-sh/speech_enhance/egs/DNS-master/s1_16k/mertrics/our_fullsubnet/NB_PESQ.txt"
)

# print(compare_two_data(data1, data2))
write_to_txt(
    "/workspace/project-nas-11025-sh/speech_enhance/egs/DNS-master/s1_16k/mertrics/compare/compare_NB_PESQ.txt",
    compare_two_data(data1, data2),
)
